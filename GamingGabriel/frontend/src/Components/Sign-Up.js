...
function SignUP(){
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:5000/api/sign-up", {
        email,
        password
      });
    ...
    return(
        ...
        <h2 className="h2222">Don't Have A Account? Create One!</h2>
        <form>
            ...
            <button type="submit" onClick={BTN}>Sign Up</button>
        </form>
        <p className="pppptag"><a href="/sign-in" className="pppptag">Have an account? Login here!</a></p>
    </div>
