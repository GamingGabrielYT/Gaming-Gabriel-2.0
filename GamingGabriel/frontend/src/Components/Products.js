  ...
  <div className="container">
    <div className="row">
        <div className="card col-md ">
            ...
            <div className="card-body">
                ...
                <p className="ppptag">The Logitech G502 is a fast, highly responsive, with fast input mouse. Despite of its looks, the G502 is popular among the gaming community.</p>
        ...
        <div className="card col-md">
            ...
            <div className="card-body">
                ...
                <p className="ppptag">The SteelSeries Apex Pro HyperMagnetic keyboard is a clicky, fast, and a popular keyboard used by gamers.</p>
        ...
        <div className="card col-md ">
            ...
            <div className="card-body">
                ...
                <p className="ppptag">Alienware 34, is a high choice of a monitor among us gamers. This monitor has 240hz refresh rate and is OLED which gives gamers a massive graphical improvement.</p>
    ...
    <div className="row">
      ...
      <div className="card col-md">
        ...
        <p className="ppptag">This gaming PC is a state-of-the-art build, this build consists of a Ryzen 7 7700X CPU, Nvidia RTX 4070 Super 12GB VRAM, 1TB Gen4 SSD, 32GB DDR5 Ram.</p>
